      ...
      <div className="flex w-full items-center justify-between">
        <Sheet>
          ...
          <SheetContent side="left" showCloseButton={false} className="w-[84vw] max-w-sm p-0">
            <SheetHeader className={`border-b p-5 ${selectedLogotypeFontName ? "py-1.5 pt-[calc(0.5rem+var(--safe-area-inset-top))]" : "py-3 pt-[calc(0.75rem+var(--safe-area-inset-top))]"}`}>
